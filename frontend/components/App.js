      ...
      <div id="membersForm">
        ...
        <form onSubmit={onSubmit}>
          <div>
            ...
            <input onChange={onChange} value={inputValue.fname} id="fname" type="text" placeholder="Type First Name" />
          </div>

          <div>
            <label htmlFor="lname">Last Name </label>
            <input onChange={onChange} value={inputValue.lname} id="lname" type="text" placeholder="Type Last Name" />
          </div>

          <div>
            <label htmlFor="bio">Bio </label>
            <textarea onChange={onChange} value={inputValue.bio} id="bio" placeholder="Type Bio" />
          </div>
